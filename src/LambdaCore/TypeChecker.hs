...
type TEnv = M.Map VarName TypeScheme
...
-- >>> runWithFreshCounter (checkType (Fun [Var "f"] (Fun [Var "x"] (App (Var "f") (Var "x")))))
-- Right (-> (-> a b) (-> a b))
--
...
--     (let [z (id true)] z)))
--
-- >>> runCheck emptyTEnv emptySubst (Let (Var "id") (Fun [Var "x"] (Var "x")) (Let (Var "y") (App (Var "id") (Lit (IntV 3))) (Let (Var "z") (App (Var "id") (Lit (BoolV True))) (Var "z"))))
...
defaultTEnv :: M.Map VarName TypeScheme
...
lookupTEnv :: TEnv -> VarName -> Maybe TypeScheme
lookupTEnv tenv name = M.lookup name tenv

insertTEnv :: TEnv -> VarName -> TypeScheme -> TEnv
